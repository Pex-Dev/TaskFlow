...
<div class="contenedor-sm">
    ...
    <form action="/perfil" class="formulario perfil" method="POST">
        ...
        <div class="acciones">            
            <button class="editar"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-pencil" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="#597e8d" fill="none" stroke-linecap="round" stroke-linejoin="round">
